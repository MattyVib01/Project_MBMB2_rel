...
\begin{titlepage}
   \begin{center}
       \vspace*{1cm}
\huge{
       \textbf{Progetto di una Web Application RESTful di un negozio di videogiochi "RiecoldddogGames"}
...
\begin{itemize}
    ...
    \item Il dipendente è colui che può svolgere semplici operazioni di gestione del magazzino interno, come ad esempio visionare prodotti disponibili o richiedere l'arrivo in lotto di prodotti. Inoltre, può occuparsi degli acquisti, delle prenotazioni e delle registrazioni dei clienti.
...
Il software ha 3 diversi attori: il cliente (Customer), il dipendente (Employee) e l'amministratore.
